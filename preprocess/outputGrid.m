...
nccreate(controlVars.outputName,'smooth_elev','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
...
nccreate(controlVars.outputName,'gradient_n_s','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
...
%west - east gradient
nccreate(controlVars.outputName,'gradient_w_e','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
...
%output aspects
nccreate(controlVars.outputName,'aspect','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
...
nccreate(controlVars.outputName,'dist_to_coast','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
...
nccreate(controlVars.outputName,'topo_position','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
...
nccreate(controlVars.outputName,'inversion_layer','Dimensions',{'x',outGrid.nr,'y',outGrid.nc},'FillValue',-999.0);
