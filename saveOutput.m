...
%    None
    ...
    nccreate(outputName,'rawField','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %intercept
    nccreate(outputName,'intercept','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %slope
    nccreate(outputName,'slope','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %normSlope
    nccreate(outputName,'normSlope','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %symapField
    nccreate(outputName,'symapField','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %symapElev
    nccreate(outputName,'symapElev','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %symapUncert
    nccreate(outputName,'symapUncert','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %slopeUncert
    nccreate(outputName,'slopeUncert','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    nccreate(outputName,'normSlopeUncert','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %defaultSlope
    nccreate(outputName,'defaultSlope','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %finalSlope
    nccreate(outputName,'finalSlope','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %finalField
    nccreate(outputName,'finalField','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %totalUncert
    nccreate(outputName,'totalUncert','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %relUncert
    nccreate(outputName,'relUncert','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
    ...
    %validRegress
    nccreate(outputName,'validRegress','Dimensions',{'latitude',nr,'longitude',nc},'FillValue',-999.0);
